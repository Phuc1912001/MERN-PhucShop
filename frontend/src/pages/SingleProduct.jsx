          ...
          <div className="col-12">
            ...
            <div className="bg-white p-3 ">
              <p>
                ...
                Voluptate suscipit voluptatem impedit laboriosam? Iusto expedita
                possimus beatae inventore laudantium similique, vitae, magni
                est, voluptatum fugiat laboriosam architecto consequuntur
                magnam. Laudantium!
              </p>
            </div>
          </div>
            ...
            <div className="review-inner-wrapper">
              ...
              <div className="reviews mt-4 ">
                <div className="review">
                  ...
                  <p className="mt-3">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Magnam, voluptatum laborum cum repellat illum iste? Quisquam
                    incidunt expedita molestias earum porro. Autem ipsam
                    accusamus fuga dolorum voluptatem soluta dolore cumque.
                  </p>
                </div>
              </div>
            </div>
