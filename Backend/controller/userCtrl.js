...
//       service: "gmail",
//       auth: {
//         user: "phucphuc1912001@gmail.com",
//         pass: "aqrsuxldhvfumcbr",
//       },
//     });

//     let details = {
//       from: "phucphuc19120012gmail.com",
//       to: email,
//       subject: "Forgot Password Link : Link lấy lại mật khẩu",
//       text: "Chào bạn nhé ",
...
const forgotPasswordToken = asyncHandler(async (req, res) => {
  ...
  try {
    const token = await user.createPasswordResetToken();
    await user.save();
    const resetURL = `Hi ${user.lastname}, Please follow this link to reset Your Password. 
                      This link is valid till 10 minutes from now.
                      <a href='http://localhost:5000/api/user/reset-password/${token}'>Click Here</>`;
    const data = {
      to: email,
      text: `chào ${user.lastname}`,
